                            ...
                            <div className="col-lg-3">
                                <div className="d-flex justify-content-end pt-3">
                                    {socialIcon.map((icons, index) => (
                                        <a className="btn  btn-outline-secondary me-2 btn-md-square rounded-circle" href="" key={index}><div>{icons.icon}</div></a>
                                    ))}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-item">
                                ...
                                <p>Address: 4th Street, S.Alangulam</p>
                                <p>Email: rvs1912@gmail.com</p>
                                <p>Phone: 98765432210</p>
